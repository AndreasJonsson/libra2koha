...
' --dir "$tabledir" --table 'caItem' --table 'caItemLocations'  --table 'caItemStatusCode' --table 'caMaterialType' --table 'shLibrary' --table 'shLibraryType' --table 'caCategory' --table 'caCategoryCheckedIn' --table 'caMarcRecord' --table 'caMarcRecords' --table 'ciILL' --table 'ciILLStatus' --table 'ciILLStatusHistory' > "$bib_tables"
...
CREATE INDEX caItemLocations_Id ON caItemLocations(Id);
CREATE INDEX caItemLocations_LocalUnit ON caItemLocations(LocalUnit);
...
CREATE INDEX ciILL_StatusId ON ciILL(StatusId);
